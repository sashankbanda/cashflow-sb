...
2. **Personal lens** — every rupee you spend (including *your share* of group expenses) flows into one personal ledger: categories, budgets, trends, insights.
...
- What is *my* net position (owed to me − I owe)?
...
| S6 | Add expense | Full-screen sheet, 3 steps: amount (custom keypad + description + category) → paid by → split; works for group *and* personal |
...
1. **Split exactness:** each expense's splits sum *exactly* to the amount, in paise, using largest-remainder distribution (₹100 / 3 → 3334 + 3333 + 3333 paise; deterministic member ordering).
